    ...
    return (
        ...
        >
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 h-full flex items-start justify-center">
                 <motion.div variants={markerVariants} className="relative w-12 h-12 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 flex items-center justify-center border-4 border-white shadow-lg z-10">
                    <step.icon className="w-6 h-6 text-white" />
                    <motion.div variants={markerGlowVariants} className="absolute w-full h-full bg-blue-500 rounded-full blur-lg" />
                </motion.div>
            </div>
        </motion.div>
    );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={containerRef} className="hidden lg:block relative max-w-4xl mx-auto">
            ...
            <motion.div 
                ...
                className="absolute left-1/2 -translate-x-1/2 top-6 w-1 bg-gradient-to-b from-blue-500 to-blue-600" 
            />
